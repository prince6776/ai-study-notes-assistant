...
Actual: Returned a clear fallback message saying the topic is not supported yet.  
Result: Pass
...
- The app now handles unsupported questions more clearly.
- The routing logic is more reliable for paraphrased inputs.
- The final version performed better than the baseline on the same test set.